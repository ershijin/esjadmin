      ...
      <el-table-column label="操作" width="160px" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button size="mini" style="margin-right: 2px" type="text">
            <router-link :to="'/system/generator/preview/' + scope.row.tableName">
              预览
            </router-link>
          </el-button>
          ...
          <el-button size="mini" style="margin-left: -1px;margin-right: 2px" type="text">
            <router-link :to="'/system/generator/config/' + scope.row.tableName">
              配置
            </router-link>
          </el-button>
...
import { generate, download, sync } from '@/api/generator/generator'
...
export default {
  ...
  cruds() {
    return CRUD({ url: 'generator/tables' })
  },
